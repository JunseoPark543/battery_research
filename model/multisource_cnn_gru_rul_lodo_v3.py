...
Expected project structure:
    ...
    └─ multisource_cnn_gru_rul_lodo_v3.py

Example:
    python model/multisource_cnn_gru_rul_lodo_v3.py --target HUST --model-name cnn_gru_baseline

Useful quick test:
    python model/multisource_cnn_gru_rul_lodo_v3.py --target HUST \
...
def main() -> None:
    ...
    if args.project_root is None:
        # Expected script location: project/model/multisource_cnn_gru_rul_lodo_v3.py
