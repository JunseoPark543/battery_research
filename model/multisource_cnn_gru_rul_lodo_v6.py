#!/usr/bin/env python
# VERSION: 6.0
# FILE: multisource_cnn_gru_rul_lodo_v6.py
# PATH POLICY:
...
Expected project structure:
    ...
    │  └─ Tongji_labels.json
    ├─ run/
    │  └─ cnn_gru_baseline_target_HUST_YYYYMMDD_HHMMSS/
    └─ multisource_cnn_gru_rul_lodo_v6.py

Example:
    python model/multisource_cnn_gru_rul_lodo_v6.py --target HUST --model-name cnn_gru_baseline

Useful quick test:
    python model/multisource_cnn_gru_rul_lodo_v6.py --target HUST \
...
Notes:
    ...
    5. Source prefixes are sampled uniformly over 10%-80% of life.
    6. Target evaluation uses both life-fraction and absolute-cycle benchmarks.
    7. Interpolated cycle tensors are cached as float16 .npy files.
"""
...
def main() -> None:
    ...
    if args.project_root is None:
        # Expected script location: project/model/multisource_cnn_gru_rul_lodo_v6.py
